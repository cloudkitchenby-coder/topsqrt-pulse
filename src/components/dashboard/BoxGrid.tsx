...
export const BoxGrid = forwardRef<HTMLDivElement, BoxGridProps>(
  ({ title, subtitle, totalCount, boxes, onBoxClick }, ref) => {
    return (
      <div ref={ref} className="bg-card/50 rounded-2xl p-6 border border-border/50 backdrop-blur-sm">
